...
# 02_face_recognition_basic.py
#
# Live face recognition demo.
# It loads a database of .bin feature files, detects faces,
# extracts features, compares them with the database, and draws result labels.
#
...
CONFIG = {
    ...
    # Change this to the folder created by 01_register_faces_from_folder.py
...
def exce_demo(pl):
    ...
    try:
        ...
        print("Face recognition demo exit:", e)
    finally:
        exit_demo()
